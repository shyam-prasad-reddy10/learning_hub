                ...
                <ul className="dropdown-menu">
                  <li>
                    <a className="dropdown-item" href="/register">
                      <i className="bi bi-code me-1"></i>FrontEnd
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="/register">
                      <i className="bi bi-code-slash me-1"></i>BackEnd
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="/register">
                      <i className="bi bi-diagram-3-fill me-1"></i>Data Structures
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="/register">
                      <i className="bi bi-cpu-fill me-1"></i>Operating Systems
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="/register">
                      <i className="bi bi-brain-fill me-1"></i>AIML
                    </a>
                  </li>
                </ul>
              </li>
      ...
      <div className="container py-5">
        <div className="row justify-content-center g-4">
          ...
          <div className="col-md-4">
            <div className="card shadow text-center p-3">
              ...
              <div className="card-body">
                ...
                <a
                  href="https://www.linkedin.com/in/kamasani-shyam-prasad-reddy-687329334/"
          ...
          <div className="col-md-4">
            <div className="card shadow text-center p-3">
              ...
              <div className="card-body">
                ...
                <a
                  href="https://www.linkedin.com/in/jaswanth-gunana-048989323/"
                  className="btn btn-outline-primary"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <div className="col-md-4">
            <div className="card shadow text-center p-3">
              <img
                src={`${process.env.PUBLIC_URL}/images/p3.jpeg`}
                className="img-thumbnail rounded-circle mx-auto"
                style={{ width: "120px", height: "120px" }}
                alt="Vinay"
              />
              <div className="card-body">
                ...
                <a
                  href="https://www.linkedin.com/in/vinay-kumar-jogi-a78604351/"
                  className="btn btn-outline-primary"
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4 mb-3">
              <h5>Learning Hub</h5>
              <p>
                Empowering learners with quality tech education. Join us to
